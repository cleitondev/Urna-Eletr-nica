let seuVotoPpara = document.querySelector('.d-1-1 span')
...
function comecarEtapa(){
    ...
    seuVotoPpara.style.display = 'none'
...
function atualizaInterface(){
    ...
    if(candidato.length > 0) {
        ...
        seuVotoPpara.style.display = 'block'
        ...
        seuVotoPpara.style.display = 'block'
        aviso.style.display = 'block'
        descicao.innerHTML = '<div class="aviso--grande pisca">VOTO NULLO</div>'
    } 
...
function confirma(){
    ...
    if(votoConfirmado){
        ...
        if(etapas[etapaAtual] !== undefined){
           ...
           document.querySelector('.tela').innerHTML = '<div class="aviso--g pisca">FIM!!</div>'
        }
    }
}
